<?php
    ...
    if($_POST){
        ...
        if(isset($_COOKIE['font-size'])){
            $_POST['font_size'] = $background_color=$_COOKIE['font-size'];
        }
    }
    //Delete Cookie
    $msg = false;
    if(isset($_POST['hapus cookies'])){
...
<head>
    ...
    <style type="text/css">
    body {
        font: <?=$font_size?> "open sans", "segoe ui", tahoma; background-color: <?=$background_color?>;
    }
    h3 {
        margin-top: 0;
        margin-bottom: 10px;
